...
Original file is located at
    https://colab.research.google.com/drive/1OCH1sRtOl-oV7kFCAeOnfirFPJtIoxX_
"""
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None, head_mask=None):
        """
        ...
        """
        if head_mask is None and hasattr(self, "head_mask"):
        ...
        if head_mask is not None:
            ...
            head_mask = head_mask.view(shape)
